...
- v2 includes instant references to the pages of the used chunks within the answer text. Furthermore, a ranking score of the retrieved chunks is implemented based on a simple heuristic of the embedding dinstance. Higher distances refer to a lower relevance score. The top-k(k=1) relevance score and the mean relevance score is appended to the answer.
